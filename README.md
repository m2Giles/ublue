...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
rpm-ostree rebase ostree-unverified-registry:ghcr.io/m2giles/m2-ublue:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
rpm-ostree rebase ostree-image-signed:docker://ghcr.io/m2giles/m2-ublue:latest
  ```
...
```
rpm-ostree rebase ostree-image-signed:docker://ghcr.io/m2giles/m2-ublue:20230822
```
